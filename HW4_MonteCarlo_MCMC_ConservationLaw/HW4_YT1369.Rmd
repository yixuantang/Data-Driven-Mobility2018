...
```
After 2000 iterations(random seed 313230), I got the decoded quote: THE WAY I SEE IT IF YOU ARE GOING TO BUILD A TIME MACHINE INTO A CAR WHY NOT DO IT WITH SOME STYLE.
This a Dialogue from the movie *Back to The Future*!
...
```
In this situation, the conservation law holds.
#### b.Using sensor 401613 as the input sensor and sensor  400536 as output sensor
```{r}
echo = FALSE
